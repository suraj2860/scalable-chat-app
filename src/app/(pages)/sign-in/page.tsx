...
export default function SignIn() {
    ...
    return (
        <div className=''>
            ...
            <EmptyAppbar />
            <form onSubmit={handleSubmit((data, e) => handleSignIn(data, e))} className='flex flex-col mx-auto mt-24 w-96 border-2 bg-white rounded-md p-6 text-sm text-gray-700'>
                ...
                <button 
                    type="submit" 
                    className="text-white w-full bg-gray-800 disabled:bg-gray-400 disabled:cursor-not-allowed  hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 flex items-center justify-center"
                    disabled={isLoading}
                >
                    {isLoading ? (
                        <>
                ...
                <button
                    ...
                    disabled={isLoading}
                    className="flex items-center mb-4 justify-center disabled:bg-gray-400 disabled:cursor-not-allowed bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 mt-4 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                ...
                <h2 className='flex justify-center text-base'>New to Chat-App? <Link href={'/sign-up'} className='text-blue-600 ml-2'> Join now</Link></h2>
            </form>
        </div>
    );
}
